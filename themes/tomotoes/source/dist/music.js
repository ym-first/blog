const ap = new APlayer({
    ...
    audio: [
      ...
      //   name: '不再犹豫-Live',
      //   artist: 'Beyond',
      //   url: 'http://music.163.com/song/media/outer/url?id=347583.mp3', 
      //   cover: 'http://p2.music.126.net/pHr2hq_QGGDrM3JOedJyVQ==/93458488373022.jpg?param=40y40',
      // },
      {
        name: "不要怕-Live",
      ...
      //   https://music.163.com/song?id=120845&userid=247206710
      // },
      // {
      //   name: "心仍是冷",
      //   artist: '梅艳芳/张学友',
      ...
      //   name: "ツナ覚醒-《家庭教师》插曲",
      //   artist: '佐橋俊彦',
      //   url: 'http://music.163.com/song/media/outer/url?id=29023858.mp3',
      ...
      // },
        ...
        //   name: "只有你不知道-Live",
        //   artist: '张学友',
        //   url: 'http://music.163.com/song/media/outer/url?id=189613.mp3',
        //   cover: 'http://p2.music.126.net/G3WbwV7xfv-V-pVE36iTTA==/18255191556505451.jpg?param=40y40',
        //   },
        {
        name: "等",

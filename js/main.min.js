...
;(function() {
	...
	// // 添加音乐播放器
	// if (G.innerWidth > 760) {
	// 	var bodywrap = document.getElementsByClassName('body-wrap')[0]
	// 	bodywrap.parentNode.insertBefore(dmusic,bodywrap)
	// 	var music = document.createElement('iframe')
	// 	music.setAttribute("id","xmusic")
	// 	music.setAttribute('allowTransparency', 'true')
	// 	music.setAttribute("frameborder","no")
	// 	music.setAttribute("width","250")
	// 	music.setAttribute("height","110")
	// 	music.marginwidth = '0'
	// 	music.loading = 'lazy'
	// 	music.sandbox = 'allow-popups allow-scripts allow-same-origin'
	// 	music.src = 'https://www.xiami.com/webapp/embed-player?autoPlay=1&id=2050735'
	// 	// music.src = 'https://music.163.com/outchain/player?type=2&id=33579298&auto=1&height=32'

	// 	bodywrap.parentNode.insertBefore(music,bodywrap)
	// }
